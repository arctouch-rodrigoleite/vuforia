...
static const char* const kAccessKey = "f866c7a6afd8e3697b89256bbdc48c0214798ef0";
static const char* const kSecretKey = "93bff068ce6c16d90942a7ba9875fc42b1396267";
...
- (bool) doInitTrackers
{
    ...
    // For Cloud Reco the recommended fusion provider mode is
            ...
            if (result->getTrackingRating() > 0)
            {
                ...
                if (newTrackable != 0)
                {
                    ...
                    dispatch_async(dispatch_get_main_queue(), ^(void){
                            self.textView.text = [NSString stringWithFormat:@"%s", newTrackable->getName()];
                    });
                }
                else
                {
